        ...
        <div class="col-md-9">
            ...
            <form @submit.prevent="handleSubmitForm">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <input class="form-control" type="Date" placeholder="Date of Birth" v-model="client.dateOfBirth" required/>
                        <small class="form-text text-muted">
                            Date of Birth
                        </small>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <div id="v-model-select">
                            <select class="form-control" v-model="client.approached">
                ...
                <center>
                    <div>
                        <button type="submit" class="btn btn-success mt-4 text-center">Register Client</button>
...
export default{
    ...
    methods: {
        ...
        handleSubmitForm(){
            ...
            axios.post(URL, this.client).then(() =>{
                history.back(1);
                this.client = {
                    firstName: '',
                    middleName: '',
